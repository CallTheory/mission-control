<div class="col-span-6 sm:col-span-4 my-4">
    ...
    <small class="text-xs text-muted">A friendly name for this schedule</small>
...
<div class="grid grid-cols-2 gap-4">
    <div class="col-span-1 my-4">
        ...
        <small class="text-xs text-muted">Select a client or leave blank for all allowed accounts</small>
    ...
    <div class="col-span-1 my-4">
        ...
        <small class="text-xs text-muted">Filter by billing code</small>
...
<div class="grid grid-cols-2 gap-4">
    ...
    <div class="col-span-1 my-4">
        ...
        <small class="text-xs text-muted">Time to send (for daily/weekly/monthly)</small>
...
<div class="grid grid-cols-2 gap-4">
    <div class="col-span-1 my-4">
        ...
        <select id="include_transcription" class="mt-1 block w-full border border-border rounded-md shadow" wire:model="state.include_transcription">
            <option value="1">Yes</option>
            <option value="0">No</option>
        </select>
        <small class="text-xs text-muted">Include transcription in email body</small>
    ...
    <div class="col-span-1 my-4">
        ...
        <select id="include_call_metadata" class="mt-1 block w-full border border-border rounded-md shadow" wire:model="state.include_call_metadata">
            <option value="1">Yes</option>
            <option value="0">No</option>
        </select>
        <small class="text-xs text-muted">Include caller, agent, time info</small>
