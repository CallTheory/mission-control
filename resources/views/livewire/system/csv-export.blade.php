    ...
    <x-form-section submit="">
        ...
        <x-slot name="form">
            <div class="col-span-6 space-y-4">
                <div>
                    <h4 class="text-sm font-semibold text-surface-fg-soft">System Toggle</h4>
                ...
                <div>
                    <h4 class="text-sm font-semibold text-surface-fg-soft">Team Access</h4>
                    <p class="text-sm text-muted mt-1">
                ...
                <div>
                    <h4 class="text-sm font-semibold text-surface-fg-soft">Account & Billing Restrictions</h4>
                    <p class="text-sm text-muted mt-1">
