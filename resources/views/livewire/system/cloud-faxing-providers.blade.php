<div class="text-left bg-surface my-3 rounded-sm border border-border shadow py-4 px-6 w-full">
    <h3 class="text-lg leading-6 font-medium text-surface-fg">Enabled Fax Providers</h3>
    ...
    <div class="mt-4 space-y-6">
        ...
        <div class="col-span-6 sm:col-span-4">
            <div x-data="{ isEnabled: $wire.ringcentral_enabled }" class="flex items-center justify-between">
                <span class="flex flex-grow flex-col">
                    <span class="text-md font-semibold leading-6 text-surface-fg" id="ringcentral-enabled-label">RingCentral</span>
                    <span class="text-sm text-muted pr-2" id="ringcentral-enabled-description">
                        Show the <strong>RingCentral</strong> fax status and resend view.
                        @unless($ringcentral_configured)
                            <span class="text-warning">No RingCentral credentials are configured yet &mdash; add them in <a class="font-semibold hover:underline" href="/system/integrations">System Integrations</a>.</span>
                        @endunless
                    </span>
                </span>
                <button
        ...
        <div class="col-span-6 sm:col-span-4">
            <div x-data="{ isEnabled: $wire.mfax_enabled }" class="flex items-center justify-between">
                <span class="flex flex-grow flex-col">
                    <span class="text-md font-semibold leading-6 text-surface-fg" id="mfax-enabled-label">mFax</span>
                    <span class="text-sm text-muted pr-2" id="mfax-enabled-description">
                        Show the <strong>mFax</strong> fax status and resend view.
                        @unless($mfax_configured)
                            <span class="text-warning">No mFax API key is configured yet &mdash; add it in <a class="font-semibold hover:underline" href="/system/integrations">System Integrations</a>.</span>
                        @endunless
                    </span>
                </span>
                <button
