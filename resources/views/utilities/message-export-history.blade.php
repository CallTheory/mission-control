@section('title', 'Message Export - Export History')
<x-app-layout>
    <x-slot name="header">
    ...
    <div class="p-4">
        <div id="toggleScreenWidthContent"
             class="max-w-7xl mx-auto transition duration-1000 ease-in-out rounded border bg-surface shadow border-border">
            <div class="m-2">
            ...
            <div class="block min-w-full px-2 mx-auto">
                ...
                <div class="mt-4">
                    <livewire:utilities.message-export-history lazy="lazy" />
                </div>
            </div>
        </div>
    </div>
