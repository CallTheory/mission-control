...
$svgClasses = 'class="w-16 h-16 mx-auto text-muted group-hover:text-surface-inverse-fg transition transform duration-700 ease-in-out"';
@endphp
<x-app-layout>
    <x-slot name="header">
                ...
                <div class="px-6 py-12 w-full mx-auto">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5  gap-x-4 gap-y-4">
                        ...
                        @can('utility.api_gateway')
                            <a class="group" title="API Gateway" href="/utilities/api-gateway">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">API Gateway</small>
                                </div>
                            </a>
                        @endcan
                            ...
                            <a class="group" title="Board Check" href="/utilities/better-emails">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" {!! $svgClasses !!}>
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Better Emails</small>
                                </div>
                            </a>
                        @endcan
                        ...
                        @can('utility.board_check')
                            <a class="group" title="Board Check" href="/utilities/board-check">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Board Check</small>
                                </div>
                            </a>
                        @endcan
                        ...
                        <a class="group" title="Call Lookup" href="/utilities/call-lookup">
                            <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                <svg class="w-16 h-16 mx-auto text-muted  group-hover:text-surface-inverse-fg
                                ...
                                <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Call Lookup</small>
                            </div>
                        </a>
                        @endcan
                        ...
                        @can('utility.card_processing')
                            <a class="group" title="Card Processing" href="/utilities/card-processing">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Card Processing</small>
                                </div>
                            </a>
                        @endcan
                        ...
                        @can('utility.config_editor')
                            <a class="group" title="Config Editor" href="/utilities/config-editor">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Config Editor</small>
                                </div>
                            </a>
                        @endcan
                        ...
                        @can('utility.cloud_faxing')
                            ...
                            <a class="group" title="Cloud Faxing" href="/utilities/cloud-faxing">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Cloud Faxing</small>
                                </div>
                            </a>
                            @endif
                        @endcan
                        ...
                        @can('utility.csv_export')
                            <a class="group" title="CSV Export" href="/utilities/csv-export">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">CSV Export</small>
                                </div>
                            </a>
                        @endcan
                        ...
                        <a class="group" title="Database Health" href="/utilities/database-health">
                            <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                ...
                                <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Database Health</small>
                            </div>
                        </a>
                        @endcan
                        ...
                        @can('utility.directory_search')
                            <a class="group" title="Directory Search" href="/utilities/directory-search">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Directory Search</small>
                                </div>
                            </a>
                        @endcan
                        ...
                        @can('utility.inbound_email')
                            <a class="group" title="Inbound Email" href="/utilities/inbound-email">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Inbound Email</small>
                                </div>
                            </a>
                        @endcan
                        ...
                        @can('utility.mcp_server')
                            <a class="group" title="MCP Server" href="/utilities/mcp-server">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">MCP Server</small>
                                </div>
                            </a>
                        @endcan
                        ...
                        @can('utility.message_export')
                            <a class="group" title="Message Export" href="/utilities/message-export">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Message Export</small>
                                </div>
                            </a>
                        @endcan
                        ...
                        @can('utility.voicemail_digest')
                            <a class="group" title="Voicemail Digest" href="/utilities/voicemail-digest">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Voicemail Digest</small>
                                </div>
                            </a>
                        @endcan
                        ...
                        @can('utility.script_search')
                            <a class="group" title="Script Search" href="/utilities/script-search">
                                <div class="bg-surface px-4 py-8 transition transform duration-700 ease-in-out group-hover:bg-surface-inverse-hover rounded-sm shadow border border-border text-center">
                                    ...
                                    <small class="mx-auto text-sm group-hover:text-surface-inverse-fg transform transition duration-700 ease-in-out">Script Search</small>
                                </div>
                            </a>
                        @endcan
