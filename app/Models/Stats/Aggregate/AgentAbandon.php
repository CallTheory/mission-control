...
class AgentAbandon extends Stat
{
    ...
    public function tsql(): string
    {
        ...
        return trim(<<<TSQL
            ...
            where statCallEnd.CompCode = 3 and statCallEnd.Kind in (1, 2, 9)
            and statCallStart.LastAgtId is not null
            and statCallEnd.Stamp between ? and ?
