...
class DiscTime extends Stat
{
    ...
    public function tsql(): string
    {
        ...
        return trim(<<<TSQL
            select avg(statCallEnd.selDisc) as [average] from statCallEnd
            ...
            where statCallStart.LastAgtId is not null
            and statCallEnd.Kind in (1,2) and statCallEnd.Stamp between ? and ?
