...
class Overview extends Stat
{
    ...
    private $client_number, $client_name, $billing_code, $client_source;

    private string $account_setting, $account_setting_value;
