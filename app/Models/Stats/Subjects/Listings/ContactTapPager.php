...
class ContactTapPager extends Stat
{
    public function tsql(): string
    {
        return trim(<<<'TSQL'
             select
                dirlistings.listId,
                dirContactTapPager.[Name] as [MethodName],
                dirsubjects.[Name] as [DirectorySubject],
                dirviews.[Name] as [View],
                dirContactTapPager.PagerId as [Result]
            from dirContactTapPager
            left join dirlistings  on dirlistings.listid = dirContactTapPager.listid
