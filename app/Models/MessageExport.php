 ...
 * @property array $selected_fields
 * @property string|null $filter_field
 * @property string|null $filter_value
 * @property bool $include_call_info
 ...
 */
class MessageExport extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'message_exports';
    ...
    /**
     * Encrypt/decrypt selected_fields as a JSON array.
     */
    protected function selectedFields(): Attribute
    {
    ...
    /**
     * Encrypt/decrypt filter_field.
     */
    protected function filterField(): Attribute
    {
        return Attribute::make(
    ...
    /**
     * Encrypt/decrypt filter_value.
     */
    protected function filterValue(): Attribute
    {
        return Attribute::make(
            get: fn ($value) => $value ? decrypt($value) : null,
            set: fn ($value) => $value ? encrypt($value) : null,
    ...
    {
        return $this->hasMany(MessageExportLog::class);
    }
    ...
    /**
     * Get the date range for fetching messages based on schedule type.
     */
    ...
    /**
     * Check if this is a manual-only export (no schedule).
     */
