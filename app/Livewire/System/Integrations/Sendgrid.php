...
class Sendgrid extends Component implements HasActions, HasSchemas
{
    ...
    {
        return 'SendGrid Inbound Parse API';
    }

    protected function infoContent(): View
    {
        return view('livewire.system.integrations.partials.sendgrid');
    }
