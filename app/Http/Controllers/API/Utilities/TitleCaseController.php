...
class TitleCaseController extends Controller
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        return response()->json($this->title_case($string), 200, [], JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES);
    }

    private function title_case(string $string): string
    {
