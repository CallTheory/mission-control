...
class TransliterateAsciiController extends Controller
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $validator = Validator::make([
            ...
            'string' => 'The `string` field is required and must be 1 characters or longer',
        ]);
        ...
        return response()->json($this->string_ascii($string), 200, [], JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES);
    }

    private function string_ascii(string $string): string
    {
