...
Convert any string to [APA Title Case](https://apastyle.apa.org/style-grammar-guidelines/capitalization/title-case).
...
A successful response will return a `200 OK` with the APA title-cased string as a JSON body.
