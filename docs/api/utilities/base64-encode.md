...
Returns the [base64](https://en.wikipedia.org/wiki/Base64) encoded string.
...
- `GET /api/utilities/base64-encode?string=Call Theory`

A successful response will return a `200 OK` with the base64-encoded string as a JSON body.
...
- `GET /api/utilities/base64-encode`
