...
Convert any string to `StudlyCase`.

## Request

**Url**: `/api/utilities/studly-case`
...
- `GET /api/utilities/studly-case?string=Call Theory`

A successful response will return a `200 OK` with the StudlyCased string as a JSON body.
