...
Convert any string to `K-E-B-A-B C-A-S-E` by words. Great for having agents spell-back a value.

## Request

**Url**: `/api/utilities/kebab-case`
...
- `GET /api/utilities/kebab-case?string=Call Theory`

A successful response will return a `200 OK` with the kebab-cased string as a JSON body.
